...
public class TeleOp2425_V3Robot extends LinearOpMode {
    ...
    private final double highRung1_2 = 49.1587;

    private final double wall = 15.0642;
    private final double wall1_2 = 31.6347;
    ...
    private final double highRung2_2 = 31.1093;
...
//            manual = true;
        ...
        if (gamepad1.left_trigger > 0.1 && !leftTriggerPressed && intake_angle < 3) {
            intake_angle = Math.max(1 - intake_angle,0);
