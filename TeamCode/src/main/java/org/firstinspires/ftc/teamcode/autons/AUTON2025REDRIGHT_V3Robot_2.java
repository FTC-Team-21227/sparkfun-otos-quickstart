...
//        pushing timing to the limits
        ...
        TrajectoryActionBuilder tab3 = drive.actionBuilder(new Pose2d(9, firstSpecDistance, Math.toRadians(-90))) //push colored samples
                .setTangent(Math.toRadians(-90))
                .splineToConstantHeading(new Vector2d(9,firstSpecDistance-3),Math.toRadians(-45))
                .splineToConstantHeading(new Vector2d(34, firstSpecDistance-3),Math.toRadians(45))
...
//                .splineToConstantHeading(new Vector2d(69, -12),Math.toRadians(0));
        TrajectoryActionBuilder tab5 = drive.actionBuilder(new Pose2d(58, -44, Math.toRadians(-90))) //go to second specimen
                .setTangent(Math.toRadians(90))
                .splineToConstantHeading(new Vector2d(58, -22),Math.toRadians(90))
                .splineToConstantHeading(new Vector2d(64, -16),Math.toRadians(0))
                .splineToConstantHeading(new Vector2d(67, -22),Math.toRadians(-90))
                .splineToConstantHeading(new Vector2d(67,-43),Math.toRadians(-90));
        TrajectoryActionBuilder tab6 = drive.actionBuilder(new Pose2d(67, -43, Math.toRadians(-90))) //pick up and place second specimen
...
//                .strafeTo(new Vector2d(40,-45.5),new TranslationalVelConstraint(30));
        ...
        TrajectoryActionBuilder tab10 = drive.actionBuilder(new Pose2d(40, -48, Math.toRadians(-90))) //pick up and place second specimen
                .setTangent(Math.toRadians(170))
                .waitSeconds(0.4)
...
//                .strafeTo(new Vector2d(40,-45.5),new TranslationalVelConstraint(30));
                ...
                .splineToConstantHeading(new Vector2d(40,-48),Math.toRadians(-12));
        TrajectoryActionBuilder tab12 = drive.actionBuilder(new Pose2d(40, -48, Math.toRadians(-90))) //pick up and place fourth specimen
                .setTangent(Math.toRadians(170))
                .waitSeconds(0.4)
...
//                .strafeTo(new Vector2d(30,-58));
                ...
                .splineToConstantHeading(new Vector2d(40,-46.5),Math.toRadians(-12));
        TrajectoryActionBuilder tab14 = drive.actionBuilder(new Pose2d(40, -46.5, Math.toRadians(-90))) //park
//                .waitSeconds(0)
                .strafeToLinearHeading(new Vector2d(-48,-74),Math.toRadians(45),new TranslationalVelConstraint(120), new ProfileAccelConstraint(-60,100));
        ...
        Actions.runBlocking(
                new SequentialAction(
                        ...
                        new ParallelAction(
                            ...
                            arm1.waitLiftWall2(0.35,1.5),
                            arm2.waitLiftWall2(0.35,1.5),
                            claw_angle.backward(0.3),
                            intake_angle.RotatePositionNegative1(0.8)
                        ),
                        claw.closeClaw(),
                        new ParallelAction(
                            arm1.waitLiftHighBasket(0.4),
                            arm2.waitLiftHighBasket(0.4),
